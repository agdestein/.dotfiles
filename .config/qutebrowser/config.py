...
## Type: String
## Valid values:
##   - lightness-cielab: Modify colors by converting them to CIELAB color space
##                       and inverting the L value. Not available with Qt < 5.14.
...
# c.spellcheck.languages = ["en-US", "fr-FR", "nb-NO", "ru-RU"]
